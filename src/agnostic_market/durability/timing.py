...
class DurabilityOperation(StrEnum):
    ...
    REGISTRY_BEGIN_CLOSE = "registry.begin_close"
    REGISTRY_CLAIM_EXPIRED = "registry.claim_expired"
    REGISTRY_REFRESH_CLOSE = "registry.refresh_close"
    REGISTRY_CLOSE_GENERATIONS = "registry.close_checkpoint_generations"
    REGISTRY_RECORD_CLOSE_DELETION = "registry.record_close_checkpoint_deletion"
    REGISTRY_FINALIZE_CLOSE = "registry.finalize_close"
    REGISTRY_REAP = "registry.reap"
    REGISTRY_TENANT_DRAIN_OBSERVE = "registry.tenant_drain_observe"
    REGISTRY_ROTATE = "registry.rotate"
    REGISTRY_CHECKPOINT_GENERATIONS = "registry.checkpoint_generations"
