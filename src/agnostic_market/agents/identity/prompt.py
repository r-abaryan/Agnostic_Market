...
_IDENTITY_INSTRUCTIONS = (
    ...
    "the caller hasn't stated it yet, ask ONE short question for it. When they state it, "
    ...
    "exactly ONE thing: a tool call WITH NO spoken text alongside it, OR one spoken "
    "fact-question - never narrate instead of acting. If the caller no longer wants "
